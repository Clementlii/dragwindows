function setTime(ts) {
  ...
  var w = new Window({
    top: 50,
    left: 20,
    title: 'Créations/Loisir',
    close: true,
    draggable: true,
    content: [
      { type: 'folder', icon: 'file', text: 'UI/UX' },
      { type: 'folder', icon: 'file', text: 'HTML/CSS' },
      { type: 'folder', icon: 'camera', text: 'PHOTOGRAPHY' },
      { type: 'folder', icon: 'book', text: 'BOOKS' },
      { type: 'folder', icon: 'pencil', text: 'GRAPHIC DESIGN' }
  ...
  var w = new Window({
    ...
    draggable: true,
    content: [
      { type: 'file', icon: 'file-pdf-o', text: 'CV' },
      { type: 'file', icon: 'spotify', text: 'Playlist' },
      { type: 'file', icon: 'github', text: 'GitHub' }
    ]
  });
